...
var resources : Array[float] = [1000,1000,1000,1000,1000,1000,1000]
...
enum perk_id{
	double_use,water_3,fire_xiajibashe,
	fire_only,fire_bomb,wuzhongshengyou,
	esc,chuizhiluoxia,none
}
var active_perk = {
